 ...
 * @brief 以xyz形式参数化的顶点
 */
class VertexPointXYZ_PJ : public Vertex {
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW;

    VertexPointXYZ_PJ() : Vertex(3) {}
 ...
 */
class VertexPose_PJ : public Vertex {
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW;

    VertexPose_PJ() : Vertex(7, 6) {
        
        // std::cout << "make VertexPose_PJ " << std::endl;
    }

    ~VertexPose_PJ() {
        
        // std::cout << "~VertexPose_PJ " << std::endl;
    }
